                ...
                <div class="col-lg-9 desctop-992-pr-16">
                    <div class="d-flex align-items-center flex-wrap mb8">
                        <?php foreach ($search_count as $search_counts):?>
                            <span class="paragraph mr16">Найдено <?=$search_counts[0]?> резюме</span>
                        <?php endforeach;?>
                    ...
                    <div class="vakancy-page-block company-list-search__block resume-list__block p-rel mb16">
                        <div class="company-list-search__block-left">
                            <div class="resume-list__block-img mb8">
                                <img src="images/<?=$resumes['Image']?>" alt="profile">
                            </div>
                        </div>

                        <div class="company-list-search__block-right">
                            <div class="mini-paragraph cadet-blue mobile-mb12">Обновлено <?=$resumes['date']?></div>
                            <h3 class="mini-title mobile-off"><?=$resumes['title']?></h3>
                            <div class="d-flex align-items-center flex-wrap mb8 ">
                                <span class="mr16 paragraph"><?=$resumes['money']?> ₽</span>
                                <span class="mr16 paragraph">Опыт работы <?=$resumes['Experience']?> года</span>
                                <span class="mr16 paragraph"><?=$resumes['age']?> года</span>
                    ...
                    <ul class="dor-pagination mb128">
                        ...
                        <li class="page-link-prev"><a href="resume-list.php?page=1"><img class="mr8"
                                                                    src="images/mini-left-arrow.svg" alt="arrow"> Назад</a>
                        </li>

                        <li><a href="resume-list.php?page=1">1</a></li>
